...
function ShotHook() {
  return (
    <svg width="48" height="76" viewBox="0 0 48 76" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Food glow blobs */}
      <ellipse cx="22" cy="42" rx="16" ry="13" fill="#1D9E75" fillOpacity="0.22"/>
      <ellipse cx="31" cy="35" rx="9" ry="8" fill="#CC8844" fillOpacity="0.18"/>
      <circle cx="17" cy="36" r="7" fill="#1D9E75" fillOpacity="0.15"/>
      ...
      {/* Badge HOOK */}
      <rect x="31" y="12" width="12" height="9" rx="2" fill="#1D9E75"/>
...
function ShotMain() {
  return (
    <svg width="48" height="76" viewBox="0 0 48 76" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <circle cx="22" cy="40" r="13" fill="#1D9E75" fillOpacity="0.10"/>
      <circle cx="22" cy="40" r="9" fill="#1D9E75" fillOpacity="0.18"/>
      <circle cx="22" cy="40" r="5.5" fill="#1D9E75" fillOpacity="0.32"/>

      {/* Coins de cadrage verts */}
      <path d="M6 13L6 18M6 13L11 13" stroke="#1D9E75" strokeWidth="1.5" strokeLinecap="round"/>
      <path d="M42 13L42 18M42 13L37 13" stroke="#1D9E75" strokeWidth="1.5" strokeLinecap="round"/>
      <path d="M6 63L6 58M6 63L11 63" stroke="#1D9E75" strokeWidth="1.5" strokeLinecap="round"/>
      <path d="M42 63L42 58M42 63L37 63" stroke="#1D9E75" strokeWidth="1.5" strokeLinecap="round"/>
    </svg>
  )
}
...
function ShotCloseUp() {
  return (
    <svg width="48" height="76" viewBox="0 0 48 76" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <circle cx="7"  cy="15" r="1.2" fill="#1D9E75" fillOpacity="0.18"/>
      <circle cx="14" cy="13" r="1.0" fill="#CC8844" fillOpacity="0.16"/>
      <circle cx="22" cy="12" r="1.3" fill="#1D9E75" fillOpacity="0.14"/>
      <circle cx="32" cy="14" r="1.0" fill="#CC8844" fillOpacity="0.18"/>
      <circle cx="41" cy="12" r="1.2" fill="#1D9E75" fillOpacity="0.14"/>
      <circle cx="7"  cy="62" r="1.2" fill="#CC8844" fillOpacity="0.14"/>
      <circle cx="43" cy="60" r="1.0" fill="#1D9E75" fillOpacity="0.16"/>
      <circle cx="38" cy="64" r="1.3" fill="#CC8844" fillOpacity="0.14"/>

      {/* Halo de focus */}
      <circle cx="24" cy="40" r="16" fill="#1D9E75" fillOpacity="0.10"/>
      {/* Cercle pointillé focus */}
      <circle cx="24" cy="40" r="13.5" stroke="#1D9E75" strokeWidth="1.2" strokeDasharray="3 2.5"/>

      {/* Texture / détails du plat dans le cercle */}
      <circle cx="19" cy="37" r="2.5"  fill="#1D9E75" fillOpacity="0.55"/>
      <circle cx="27" cy="35" r="2.0"  fill="#CC8844" fillOpacity="0.50"/>
      <circle cx="30" cy="42" r="3.0"  fill="#1D9E75" fillOpacity="0.42"/>
      <circle cx="20" cy="44" r="2.0"  fill="#CC8844" fillOpacity="0.42"/>
      <circle cx="28" cy="45" r="2.5"  fill="#1D9E75" fillOpacity="0.48"/>
      <circle cx="23" cy="39" r="1.5"  fill="#FFFFFF"  fillOpacity="0.60"/>

      {/* Lignes de zoom depuis les coins */}
      <line x1="5"  y1="12" x2="12" y2="27" stroke="#1D9E75" strokeWidth="0.6" strokeOpacity="0.35"/>
      <line x1="43" y1="12" x2="36" y2="27" stroke="#1D9E75" strokeWidth="0.6" strokeOpacity="0.35"/>
    </svg>
  )
}
...
function ShotResult() {
  return (
    <svg width="48" height="76" viewBox="0 0 48 76" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Halo assiette */}
      <circle cx="24" cy="41" r="16" fill="#1D9E75" fillOpacity="0.07"/>
      {/* Assiette */}
      ...
      {/* Plat sur l'assiette */}
      <circle cx="24" cy="41" r="7" fill="#1D9E75" fillOpacity="0.20"/>
      <ellipse cx="22" cy="40" rx="4" ry="3.5" fill="#1D9E75" fillOpacity="0.38"/>
      <ellipse cx="27" cy="42" rx="3" ry="2.8" fill="#CC8844" fillOpacity="0.28"/>

      {/* Sparkles */}
      <path d="M38 23L38.6 25.2L40.5 25.8L38.6 26.4L38 28.6L37.4 26.4L35.5 25.8L37.4 25.2Z" fill="#1D9E75"/>
      <path d="M11 19L11.4 20.8L13.2 21.2L11.4 21.6L11 23.4L10.6 21.6L8.8 21.2L10.6 20.8Z" fill="#1D9E75" fillOpacity="0.60"/>
      <path d="M39 53L39.3 54.6L41 54.9L39.3 55.2L39 56.8L38.7 55.2L37 54.9L38.7 54.6Z" fill="#CC8844" fillOpacity="0.80"/>

      {/* Badge ✓ */}
      <circle cx="35" cy="31" r="5.5" fill="#1D9E75"/>
...
function ShotCTA() {
  return (
    <svg width="48" height="76" viewBox="0 0 48 76" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <ellipse cx="18" cy="31" rx="14" ry="12" fill="#1D9E75" fillOpacity="0.18"/>
      ...
      <rect x="8" y="54" width="32" height="9" rx="4.5" fill="#1D9E75"/>
      ...
      <line x1="40" y1="48" x2="40" y2="52" stroke="#1D9E75" strokeWidth="1" strokeLinecap="round"/>
      <path d="M38 50.5L40 52.5L42 50.5" stroke="#1D9E75" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  )
}
